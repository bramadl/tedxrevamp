...
<section class="_tedx_section _tedx_section_about" data-scroll-section>
  <div style="display: inline-block;">
    ...
    <div class="_tedx_section_about_cta">
      <div class="_tedx_link" cursor-class="hover"><a class="go-to" href="{{ url('/about#about-ted') }}">About TED</a></div>
      <div class="_tedx_link" cursor-class="hover"><a href="{{ url('/about') }}">About TEDxUniversitasBrawijaya</a></div>
      <div class="_tedx_link" cursor-class="hover"><a class="go-to" href="{{ url('/about#about-tedx') }}">About TEDx</a></div>
    </div>
  </div>
</section>
