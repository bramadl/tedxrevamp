...
<section class="_tedx_section _tedx_section_livestream">
    <div style="display: inline-block;">
        ...
        <div class="_tedx_section_about_cta">
            <div class="_tedx_link" cursor-class="hover"><span>Hello, {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}!</span></div>
            <div class="_tedx_link" cursor-class="hover"><a href="{{ url('/member/dashboard') }}">Kembali ke Beranda</a></div>
        </div>
    </div>
</section>
<div style="flex: 1;"></div>
